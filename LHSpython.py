...
dfmcols=[1,2,3,4,5]
dfm=pandas.read_excel(
	io='feecopy.xlsx',
	sheet_name='Daily Fees Entry',
    usecols=dfmcols,
    converters={'Date':str,'Adm':str})
...
lbl1=tk.Label(window, text="Enter Student Name",bg='#03001C', fg='#B6EADA', font=("Calibri", 10),bd=0)
lbl1.place(x=10,y=10)
#Creates the entry box and link the e1_value to the variable
e1_value=tk.StringVar()
e1=tk.Entry(window, textvariable=e1_value,bg='#301E67',fg='#B6EADA')
e1.place(x=10,y=30)
...
#Creates a text box
t1=tk.Text(window,height=30,width=150,bg='#301E67',fg='#B6EADA',relief="groove",borderwidth=4)
t1.place(x=150,y=0)
#Creates a button
b1=tk.Button(window,
             text='Search',
...
def search_df2(*event):
    ...
    searchnew=(new.loc[summer["Adm"].str.contains(e2_value.get(),
                               na=False, #ignore the cell's value is Nan
                               case=False)]).transpose() #case insensitive
    searchdfm=dfm.loc[dfm["Adm"].str.contains(e2_value.get(),
                               na=False, #ignore the cell's value is Nan
                               case=False)] #case insensitive
    e1.delete(0, "end")
    e3.delete(0, "end")
    ...
    t5.insert(tk.END,searchdfm)
lbl2=tk.Label(window, text="Enter Admission Number",bg='#03001C', fg='#B6EADA', font=("Calibri", 10))
lbl2.place(x=5,y=80)
#Creates the entry box and link the e1_value to the variable
e2_value=tk.StringVar()
e2=tk.Entry(window, textvariable=e2_value,bg='#301E67',fg='#B6EADA')
e2.place(x=10,y=100)
#execute the search_df function when you hit the "enter" key and put an event
#parameter
...
def search_df3(*event):
    ...
    t5.delete("1.0", "end")
    t1.insert(tk.END,search_result)
lbl3=tk.Label(window, text="Enter Phone Number",bg='#03001C', fg='#B6EADA', font=("Calibri", 10))
lbl3.place(x=10,y=150)
#Creates the entry box and link the e1_value to the variable
e3_value=tk.StringVar()
e3=tk.Entry(window, textvariable=e3_value,bg='#301E67',fg='#B6EADA')
e3.place(x=10,y=170)
#execute the search_df function when you hit the "enter" key and put an event
#parameter
...
t2=tk.Text(window,height=10,width=150,bg='#301E67',fg='#B6EADA',relief="groove",borderwidth=4)
t2.place(x=150,y=220)

t3=tk.Text(window,height=10,width=150,bg='#301E67',fg='#B6EADA',relief="groove",borderwidth=4)
t3.place(x=425,y=220)

t4=tk.Text(window,height=10,width=150,bg='#301E67',fg='#B6EADA',relief="groove",borderwidth=4)
t4.place(x=700,y=220)

t5=tk.Text(window,height=10,width=450,bg='#301E67',fg='#B6EADA',relief="groove",borderwidth=4)
t5.place(x=150,y=350)
